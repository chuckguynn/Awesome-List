...
class MusicsControllerTest < ActionController::TestCase
  ...
  test "should create music" do
    assert_difference('Music.count') do
      post :create, music: { album: @music.album, artist: @music.artist, comments: @music.comments, favorite_song: @music.favorite_song, genre: @music.genre, user_id: @music.user_id }
    end
  ...
  test "should update music" do
    put :update, id: @music, music: { album: @music.album, artist: @music.artist, comments: @music.comments, favorite_song: @music.favorite_song, genre: @music.genre, user_id: @music.user_id }
    assert_redirected_to music_path(assigns(:music))
  end
